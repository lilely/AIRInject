...
@interface WeakScopeTestCase : XCTestCase

@end

@implementation WeakScopeTestCase
...
/*
 Testcase001 : Test Weak scope
 */
- (void)testCase001 {
    AIRContainer *container = [[AIRContainer alloc] initWithScope:AIRScopeTypeWeak parent:nil];
